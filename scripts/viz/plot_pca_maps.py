...
extraction for both cities in one process:
  python -m scripts.viz.plot_pca_maps --task extract:Vienna
  python -m scripts.viz.plot_pca_maps --task extract:HongKong
  python -m scripts.viz.plot_pca_maps --task plot
