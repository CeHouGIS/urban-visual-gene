...
road_graph_nodes.parquet and the full candidate pano set; extracts NO features.
  ...
  python -m scripts.sampling.bench_sampling --city Vienna --budgets 500 2000 5000
"""
...
from scripts.core.cities import load_panos, out_dir
from scripts.sampling.pano_sampling import (covered_count, greedy_select, grid_thin,
                                   to_xy)
