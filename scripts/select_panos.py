...
features for the chosen, well-spread panos.
  ...
  python -m scripts.select_panos --city Vienna --max-panos 500
"""
...
from scripts.cities import load_panos, load_roads, out_dir
from scripts.io_utils import save_report
from scripts.pano_sampling import select_greedy_pano_ids
